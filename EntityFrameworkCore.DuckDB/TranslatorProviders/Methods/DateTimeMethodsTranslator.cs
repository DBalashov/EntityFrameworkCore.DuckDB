...
sealed class DuckDBDateTimeMethodsTranslator(ISqlExpressionFactory sqlExpressionFactory) : IMethodCallTranslator
{
    public SqlExpression? Translate(SqlExpression? instance, MethodInfo method, IReadOnlyList<SqlExpression> arguments, IDiagnosticsLogger<DbLoggerCategory.Query> logger)
    {
        ...
        if (sqlExpressionFactory.TryToDateTimeMethodMap<DateTime>(method, instance, arg, out var expression))
            return expression;
